@echo off
REM Launches the animation editor on Windows (cmd.exe). Uses the shared
REM repo-level venv at <repo>\venv; creates it on first run.
...
REM Idempotent — pip skips already-satisfied requirements quickly.
